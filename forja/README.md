...
| `FORJA_ASSETS_DIR` | Onde salvar PNG renomeadas (padrão: `~/Codex-Batavi/codex-batavi/lore-images`) |
...
| `generate` | Enfileira o workflow, aguarda (WebSocket + `/history`), move o PNG mais recente para `lore-images` (ou `--assets-dir`). |
