...
Selene-Black hung in the giant’s well like a stone in a throat — close enough to **feel** tidal shear in the hulls, far enough to pretend the Administratum’s maps were still **honest**. The Orks had claimed a **dead** refinery spine and made it a **cathedral** of rust: gantries welded at angles that mocked load tables, lift shafts packed with shoota nests, rokkit junk hung as **lintels** to waste *auspex* and **skin** jump packs on contact.
...
— **We need beacon green on the apex ring. Not “soon.” Not “almost.”** Green.

Sturmwahl’s answer was timing-coded, the way his dossier would later describe all his *vox*.

— **If you can see the landing zone from here,** — pause, just long enough to be cruel — **you’re already late.**

He sealed his helm.

---

## III. PHASE A — MID-SPINE HOOKS
...
## IV. PHASE B — THE TRUSS FACE

Below the mid-spine hooks, the outer truss became a **map** of descent.

Assault Intercessors dropped along exposed beams under cover from Phase A, grav-comp screaming honest warnings Sturmwahl’s ear liked. Melta teams burned generator couplings deck by deck — not **rage**, **starvation**. Each cut removed one meal from Gutgrind’s cage until the field began to **hiccup** and the Navy liaison’s channel gained a note almost like hope.
...
## V. PHASE C — THRONE DECK

Gutgrind’s platform stank of oil, fungus, and **confidence** the way a forge stank of work.

The Warboss swung a chain-claw heavy enough to **spall** ceramite; sparks leapt where it kissed Sturmwahl’s shoulder field. The Legatus did not trade strength for strength. He answered with **economy** — the kind taught on Aethelgard when the enemy was faster than human fear: **power axe** through neck seal, backswing splitting secondary xenos heart the *Apothecarion* would later sample and file under *orkoid redundancy*.

Gutgrind **folded** like machinery deprived of its main gear.

There was no speech worth recording. There was only **beacon green** — eleven hours from first touchdown — a color the Navy understood better than poetry.
...
*Register extract:* [aar-vex-v-gutgrind-descent.md](../vexillum-register/aar-vex-v-gutgrind-descent.md)
