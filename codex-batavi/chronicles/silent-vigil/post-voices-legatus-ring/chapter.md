...
— Old Voices locked the proposal — he said. — This session records whether the nine can carry it without breaking the line when grief arrives dressed as loyalty.
...
Varro answered without warmth.

— Tier three is not measured fire. It is continuity law at confirmed inversion. Write your dissent if you need a cleaner metric. Do not ask the doctrine to lie for your ledger.

Kessler held the mark. He did not look away.

— Then I will write dissent — he said. — Not on the frame. On the optics. The frame stands.

The room accepted that the way forge floors accept sparks — briefly bright, then back to work.
...
Armin’s jaw tightened once.

— And if command inversion **is** the breach?

Gervas met him without flinching.
...
Drusus zoomed the matrix without comment. Varro let the objections stand until the air thinned.

Radulf spoke from the witness line for the first time.

— You are building a barricade — he said. — Not a victory monument. If any of you need blessing, leave now.

No one left.

---

Varro keyed two columns on the hololith.

FULL CUSTODY — TIER A  
LIMITED CUSTODY — TIER B  
OBJECTIVE AWARENESS — TIER C
...
Armin pointed at Tier B.

— Kadmos and Otho stay execution-only?

— Execution geometry and handshake clarity — Drusus said. — No full rationale tree. Dual confirm from my office and Varro’s before scope expands.

— Good — Armin said. — They act when scoped clean.
...
Varro faced the ring again.

— Tier C — Castellan band. Objective awareness only. He knows the protocol exists and why. He does not receive kill-path architecture.

Silence held — not agreement, only the absence of useful objection.

— Consensus — Varro said — is declared when no Tier A holder files blocking dissent within this window. Kessler’s note is audit liability, not barricade removal.

He looked station to station. No blocking dissent came.
...
Armin picked up his helm.

— Give me the drill vault when ready — he said. — I want false command and noise, not ceremony.

Drusus closed the slate.

— Working title unchanged — he said.

The header projected one last time.
