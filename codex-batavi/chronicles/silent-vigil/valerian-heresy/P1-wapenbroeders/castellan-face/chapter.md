# The Brother War — *Castellan Face*

**Valerian Heresy** · **Chapter 3 of 25** · *Castellan Face*
**Strategium anchor:** ~046 *(timestamp sweep pending)*
**Quarter:** P1 — Wapenbroeders
**Theater:** Central bastion / parade geometry
**Status:** **Scaffold** — structure only; prose not drafted.

*Beat lock:* Mortals name Castellan before First Legatus; innocent credit seed.
...
**Precedent:** [two-power-pact](../../P0-bisection/two-power-pact/chapter.md)
...
**End of Chapter 3** · **Next:** [campaign-table](../campaign-table/chapter.md)
