# The Brother War — *Campaign Table*

**Valerian Heresy** · **Chapter 4 of 25** · *Campaign Table*
**Strategium anchor:** ~048 *(timestamp sweep pending)*
**Quarter:** P1 — Wapenbroeders
**Theater:** Strategium / shared tactical tables
**Status:** **Scaffold** — structure only; prose not drafted.

*Beat lock:* Same language as Malakor hook; co-rule still works.
...
**Precedent:** [castellan-face](../castellan-face/chapter.md)
...
**End of Chapter 4** · **Next:** [threshold-cheek](../threshold-cheek/chapter.md)
