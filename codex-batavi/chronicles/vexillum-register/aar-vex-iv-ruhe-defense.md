...
**Tyranid** spearhead under **Shadow in the Warp** — swarm-scale **psychic veil** degrading **standard** auspex and **morale** baselines. Terrain: **high-gravity** shingle **trenches** and **grav-locked** revetments (**Incus-Gravis**-class training ground).

## 2. Mission

**Deny** breakthrough until **Navy** **bombardment** window; **preserve** trench **spine** integrity for **fire** solution handoff.
...
Severe — **within** *Strategium* **acceptable** envelope for **buying** **orbital** **window**. Exact cell count: **redacted** in public register; **families** notified per **Chapter** rite.
