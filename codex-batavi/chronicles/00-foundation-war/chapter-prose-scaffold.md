...
- `#` Title: **The Crucible Book [I–IV]** — *Italic Chapter Title*
...
## 2. Macro-structure (how Ch. 7 is built)

| Layer | Ch. 7 pattern |
|--------|----------------|
| **Scene breaks** | **No** `---` stanzas inside the body. Movement is carried by **paragraph turns**, not rule lines. |
| **Paragraph unit** | Each paragraph does **several jobs**: advance plot, deepen motive, ground sensory detail, or braid two timelines (e.g. Torven + present pier). |
| **Length** | Expect **roughly 8–14 paragraphs** of body prose for a standard chapter; shorter only if the beat is intentionally narrow. |
| **Closing** | One `---` before `**End of Chapter**` / *Next:* line (same as Ch. 7). |

This **differs** from Ch. 1’s *many* mid-scene `---` cuts. When revising older chapters, **collapse** scenic stanzas into **paragraph sequences** unless a hard jump in time/place truly needs a rule.

---

## 3. Depth requirements (what “Ch. 7 depth” means)
...
- **Dialogue** — sparing; when it appears, it should **turn** power (Drusus threat, Iria translation, boy’s indirect accusation).
- **Terminology** — Follow project rules: *Codex*, **Wolf’s Curse**, Dark Age of Technology (not DAoT as default in EN), Varro’s helm era (*Codex* death-skull vs *Executor* post–CV y13) per dossier / `.cursorrules`.
...
| Chapter | Role |
|---------|------|
| [`chapter-07-living-specimen.md`](chapter-07-living-specimen.md) | **Structure + depth** template |
| [`chapter-08-cord-weight.md`](chapter-08-cord-weight.md) | Continuity thread from Ch. 7 (exam → firebase) |
| [`chapter-09-second-quarter-brief.md`](chapter-09-second-quarter-brief.md) | Same prose contract with **many** paragraphs (brief scene); still **minimal** `---` |

Older chapters with **staccato** layout or **montage** `---` stacks should be migrated **toward** this scaffold over time.
