# Post–Silent Vigil chronicles

**Span:** mature **~150.M42+** era — Noviomagus and mesh-internal crises after the Silent Vigil lattice hardened.

**Staff context:** [`contingency-axiom-lupus.md`](../../personae-command-index/doctrine-and-organs/contingency-axiom-lupus.md) · [`protocol-access-matrix.md`](../../personae-command-index/doctrine-and-organs/protocol-access-matrix.md) · Silent Vigil arc [`../06-silent-vigil/`](../06-silent-vigil/)
