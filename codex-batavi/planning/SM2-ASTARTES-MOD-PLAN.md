...
| **Chaplain** | ***Reclusiam*** / **Varro** network — rite, skull law, *Axiom* speech. | Ministerial read: **ashen** or **black** chapel elements **without** drowning Batavi grey–crimson; **Executor** wolf-skull + **red** lenses for full Chaplains; human death-skull + **orange** for **Mortivigil** if kit allows. Varro: incense jaw vents, fire-orb eyes, pack thurible + flanking candles when modelable. |
