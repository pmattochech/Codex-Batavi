...
| **P1** | Arcs you extend most often (e.g. `chronicles/silent-vigil/iron-venus/`, `sigma-moon/`, `vigilax/`, `apotheosis/`) | High reader and author traffic |
...
| **P1** | `chronicles/silent-vigil/iron-venus/`, `sigma-moon/`, `vigilax/`, `apotheosis/` (prose in place; English path slugs) | **Done** |
