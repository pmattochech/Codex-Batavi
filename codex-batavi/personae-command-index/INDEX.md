...
- [combat-doctrine.md](doctrine-and-organs/combat-doctrine.md) — **Combat Doctrine** (Index voice: hold the wall; four stripes + three rims as one grammar)
...
- [dossier-alaric.md](character-dossiers/triumvirate/dossier-alaric.md) — section header + dossier **Alaric von Helis**
- [dossier-varro.md](character-dossiers/triumvirate/dossier-varro.md)
- [dossier-drusus.md](character-dossiers/triumvirate/dossier-drusus.md)
...
- [dossier-radulf-castrin.md](character-dossiers/cohorts-and-detachments/dossier-radulf-castrin.md) — **Radulf Castrin**, **The Old Wolf** (**Castraferrum**, **DECIMA**) — mentor / guard dog; Portas war-wake **Alaric** only; entombment **TBD**
...
- [dossier-valerius.md](character-dossiers/expunged/dossier-valerius.md) — **EXPUNGED** — First Legatus; the traitor; The Malakor V Incident (050.M42)
