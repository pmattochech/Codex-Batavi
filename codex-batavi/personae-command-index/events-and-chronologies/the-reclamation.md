...
| **the Hold** | **~300 years.** Still **pre-Cadia**. Nine Vexilla. Fence is cage **most of the time**. Anomaly opens **~once per 20 years**. Tithe **always overproduced** (Badab / Huron lesson). **DECIMA** (once it exists) is **core escort** of the tithe hulls. |
