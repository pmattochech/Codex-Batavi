...
**Founding:** **Unknown** (numbered Founding not disclosed). Operational rebirth: **the Reclamation** (**pre-Cadia**, year TBD). Civic myth frame *Der Batav*: [der-batav-myth.md](../lexicon-and-litanies/der-batav-myth.md) — **not** a campaign naming receipt. Imperial cross-filings are **approximate**. See [the-reclamation.md](events-and-chronologies/the-reclamation.md), [master-chronology.md](events-and-chronologies/master-chronology.md).
