...
**Steppenwolves (detached registry):** A minority of battle-brothers remain **lawful Chapter strength** while operating **outside** the home **Vexillatio** rhythm — the lattice **tames** most wolves but **over-sharpens** a few; distance and long-watch geometry can read as **more stable** than garrison. *Strategium* classifies them as **alternate appliance**, not exile. **Watch accounting:** their **Deathwatch** (and allied detached) **headcount** is **exception-listed** — not folded into the **standard capped rotation pool** ([deathwatch-and-batavorum.md](../../political-relations/deathwatch-and-batavorum.md) §4). Full doctrine: [steppenwolf-doctrine.md](steppenwolf-doctrine.md).
...
| Vexillatio Apothecaries (*Medicinae*)             | **4**     | ~1 per 100 sub-cohort; one senior **Genetor Vexilli** on *Alabarda* relay per vex                                                                            |
