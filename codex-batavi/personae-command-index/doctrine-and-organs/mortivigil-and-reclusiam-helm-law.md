...
**Chapter class name:** Full soul-office = **Wolfkeeper** (Imperial gloss: Chaplain). Office duties and naming ladder: [wolfkeeper-and-reclusiam.md](wolfkeeper-and-reclusiam.md). Licensed liturgy: [tenets-of-the-grey-wolves.md](../../lexicon-and-litanies/tenets-of-the-grey-wolves.md).

**Cross-reference:** [dossier-varro.md](../character-dossiers/triumvirate/dossier-varro.md) · [wolfkeeper-and-reclusiam.md](wolfkeeper-and-reclusiam.md) · [amissi-the-lost.md](amissi-the-lost.md) · [steppenwolf-doctrine.md](steppenwolf-doctrine.md) · [military-hierarchy.md](military-hierarchy.md) · [chapter-organization.md](../chapter-organization.md) § Fortress / Crypts / *Reclusiam* · [frontier-wolf-rite.md](frontier-wolf-rite.md)
...
**Not** “permission to wear the wolf-skull” (that is now default Wolfkeeper livery).

**Is** Varro’s written sanction naming a **full Wolfkeeper** to lead and keep **Batavi** brothers on **detached / far-field** geometry — specifically **The Lost (*Amissi*)** and **Steppenwolf** registries — often far from Castra Vetera. Principal job: prevent identity stray (cult, guest-Chapter echo, personal legend, Brass drift).
...
Varro’s wolf-skull is the **same family** as line Wolfkeepers, plus **Judex-only** additions — **always on**:
