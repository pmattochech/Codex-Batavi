# REMONSTRATIO DOCENS (REMOSTRANCE)

**System (manual name):** Remonstrance (*Remonstratio Docens*).
...
## 1. Operational rule: planning open, execution sealed

**Planning phase:** Every neophyte is taught to challenge *plans*, not persons. A neophyte may object even to a plan authored by Alaric, provided the objection is structured and directed toward *Successus Missionis*.

**Execution phase:** Once sealed, the plan is executed. New information is reported in sterile terms (contact updates, invalidated assumptions, altered constraints), not litigated as debate.

**Chaplaincy line:** The Judex and subordinate Chaplains explicitly teach that remonstrance is not insubordination; it is **maintenance**. Insubordination begins when a brother uses objection to slow obedience, to recruit support, to posture pride, or to fracture command unity in the moment of contact.

---

## 2. The Soldier’s Rite: Tripudium

The manual names the structure. The rite is not triggered by spoken keywords; the Batavi performs it as naturally as breath.

- **Fractura (the Break):** Identify the precise failure point in the plan (what will break, not what feels wrong).
- **Locus (the Place / Condition):** State where, when, or under which conditions the failure will occur.
- **Propositio (the Proposal):** Offer a constructive alternative that repairs the break. A complaint without a proposal is filed as noise.

**Grading note (neophyte drill):**
- Silence is the worst failure (it trains blind following).
- Vague objection is second-worst (it trains noise).
- Precise objection with a wrong proposal is acceptable (it trains courage and structure).
- Precise objection with a correct proposal is excellence.

---

## 3. The Officer’s Rite: Correctio Didactica

Officers are obligated to convert objection into education, not humiliation. If the junior is wrong, the officer must also explain **how the junior could have been right** (what variable would change the conclusion), so the mind learns the shape of truth rather than the taste of submission.

- **Ratio Defectus (the Reason of Defect):** A clear explanation of why the soldier’s counter-proposal fails.
- **Factor Incompertus (the Unascertained Factor):** The missing variable(s) not accounted for. Filed categories:
  - **Cognitio** (intel / reconnaissance)
  - **Assumptio** (assumptions / priors)
  - **Tempus** (time / windows / sequencing)
  - **Materia** (supply, munitions, mass, structural composition, maintenance reality)
  - **Animi** (morale, terror, cohesion, cultural limits of attached forces)
- **Admonitio Melioris (guidance toward the Better):** Coaching that sharpens the soldier’s next objection; includes the explicit clause “how you could have been right.”

---

## 4. The Controlled Failure Chamber (drill rite)

Neophytes are placed in a mock strategium where veterans present plans engineered to contain one hidden fracture (and sometimes none). The intent is twofold:

- Train the **nerve** to speak without ego.
- Train the **craft** to object with precision.

**Doctrine clause:** A Batavi is not trained to be contrarian. Sometimes the correct action is to state: no objection; the plan holds.

---

## 5. Export hazard: remonstrance outside the Chapter

Batavi serving outside the Chapter (Deathwatch, military exchange, joint campaigns) often perform remonstrance instinctively. Outsiders do not know Batavi manual terms; they only witness the act: a subordinate contradicting a superior’s plan in an unheated, mechanical way.

This creates predictable stress points:

- **Positive outcome:** Plans harden, hidden fractures surface early, and allies learn to value the Batavi as a reliability instrument.
- **Negative outcome:** Pride cultures read the act as insolence; command interprets it as a public challenge; interpersonal fractures form even when the objection is correct.

**Batavi self-justification (field-phrase):** “To not die stupidly.” This phrase is not ritual; it is the unadorned motive that often escalates friction because it can be overheard by the very authority being corrected.

---

## 6. Examples: rite in unfavorable environments (witnessed)

### Example A — Deathwatch briefing chamber (third-party witness)

Watch‑Sergeant Kallistratus had learned to hear the moment a room chose comfort over accuracy. It always sounded like smooth assent.

The hololith above the strategium table threw a wireframe of the hab‑spire district into the chamber. Enemy heat ghosts pulsed in stale intervals, half‑truths stamped with time.
...
The atrium breathed ash like a lung.
...
### Example B — Joint campaign war council (third-party witness)

Quartermaster‑Adjunct Veyro had served long enough to distrust any plan described as “clean.” Clean plans belonged to men who hadn’t yet smelled their own burning supplies.

The war council occupied a half‑ruined basilica. Saints stared down as faceless stone. A map‑slate lay on a cracked altar, its surface crawling with trench lines and breach marks.

An Imperial Fists Castellan stood at the altar like a monument. Two Cadian officers hovered at his flank. An Adepta Sororitas Hospitaller watched without blinking. The Batavi exchange brother stood slightly apart, as if he didn’t trust the room’s angles.
...
The Castellan studied the overlays.
