...
* **Symbol:** A **white** wolf (**chimeric phenotype** on sealed clinical registers; **open record:** progenitor unknown) holding a horizontal gladius in its jaws, over stylized waves (amphibious origin). **Seal stays white** — not the living *Canis Batavorum* (dark guard, grey underpelt). Heraldic charge only.  
* **Armor colors:**  
...
*See also: [combat-doctrine.md](combat-doctrine.md) — Combat Doctrine hub (pointer; no new law).*
...
**Curse psychology:** During training, the neophyte is conditioned to understand the terror hierarchy of **Wolf’s Curse**. Though yielding to *Furor* is not the norm in recruitment — treated as a dangerous slip, not a rule — the legionary learns early that mutation is not a berserker gift. For a Batavi, the curse is the deepest functional shame, visible proof the warrior gave in to the monster. That perception drives instinctive **line** and **Vexilla** responses to affected brothers:  
