...
**Bearer of:** *Alabarda* (weapon — relay / *auspex* on the haft). **Vexilla banner:** **1st company** captain (PRIMA) — **four-field** face per [vexilla-by-vexilla-design.md](../../intro-and-heraldry/vexilla-by-vexilla-design.md): fourth quadrant is **obligation / remembrance** (Malakor–Valerius register), **broken-cog** border; *Strategium* brief to PRIMA transfers: *debt we carry — not a crime you committed* (§2.2).  
