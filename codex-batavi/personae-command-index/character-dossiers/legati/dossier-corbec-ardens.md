# \[WIKI\] CHARACTER DOSSIER: CORBEC ARDENS
...
**Bearer of:** *Alabarda* (weapon — relay / *auspex* on the haft). **Vexilla banner:** **Ancient** (PRIMA) — default Chapter face + LATIN-CAPS per [vexilla-by-vexilla-design.md](../../intro-and-heraldry/vexilla-by-vexilla-design.md); **obligation / remembrance** (Malakor–Valerius register), **broken-cog** border; *Strategium* brief to PRIMA transfers: *debt we carry — not a crime you committed* (§2.2). The **1st captain** does **not** hold the cloth.  
...
* **Temperament:** Patient, intolerant of “heroic” waste — treats ammunition economy as moral law.  
* **Voice:** Low, few words; prefers **tables** and embarkation manifests over speeches.  
* **Known stressor:** Commands the seat **Valerius** stained; Corbec does **not** invoke the traitor’s name in orders — only **precedent gaps** (“the First Legatus error”) when *Strategium* forces audit language.  
* **Field quote (attributed):** *“If the line outruns the forge, we are already dead — we simply haven’t filed the notice.”*
...
* **Valerian Heresy (050.M42):** One of **five** PRIMA **lawful witness** brothers who did not follow the *Lupercal* claim; *Strategium*-restricted files tie his lane to containment work against Valerius’s expunged **First Sword**, **Cassian Vorn** (second **lucid Versibar**). The same register records his engagement with the **Chapter halberd** on the **Legatus** pattern — *Alabarda* reach and head geometry **without** the office relay, witness arming from the PRIMA rack — not yet bearer of the Legatus pole he would later carry. The **Vexilla banner** is **Ancient** cloth, never mounted on that haft. Full geometry **Malakor** register — not public *Legatus* biography.  
...
* **~183.M42 | Ferrum-Secondus Wolf Ledger (PRIMA watch):** Received Branimir’s **amber** chalk report on secure vox; filed *watch Vespera* margin — *Soon* when idol morphology adds **teeth** and **title** (pre–**189** Red Harvest). Narrative: [ferrum-secondus-wolf-ledger.md](../../../chronicles/post-vigil/ferrum-secondus-wolf-ledger/chapter.md).
