# \[WIKI\] CHARACTER DOSSIER: THERON BRACH
...
**Bearer of:** *Alabarda* + Vexilla (TERTIA lattice). **Vexillum register:** four-field panel (§3) — [vexilla-by-vexillatio-design.md](../../intro-and-heraldry/vexilla-by-vexillatio-design.md).  
...
* **Temperament:** Controlled heat — jokes in the briefing, **ice** on the trigger when promethium geometry is wrong.  
* **Voice:** Loud enough for roaring refineries; drops to whisper for **det-charge** timing.  
* **Flaw:** Personal guilt catalog of **early-career** overpressure mistakes — drives obsessive **drill repetition**; some captains resent the redundancy until it saves them.  
* **Field quote (attributed):** *“Fire remembers every shortcut you took. So do I.”*
...
* **Drusus:** Regular *Medicinae* traffic — burn cascades and **Furor** spikes correlate in Brach’s theater; clinical trust, no warmth theater.  
* **Kadmos:** **Armourium** liaison on seal kits and promethium feed architecture — arguments are technical, loud, productive.  
* **Peer Legati:** Respected as **dirty-work** specialist; sometimes **borrowed** for other theaters’ chem emergencies under *Strategium* tasking.
