# \[WIKI\] CHARACTER DOSSIER: IVAR MALEVENT
...
**Bearer of:** *Alabarda* (weapon — relay / *auspex* on the haft). **Vexilla banner:** **Ancient** (OCTAVA). Default Chapter face + LATIN-CAPS; **not** 1st captain. Register: [vexilla-by-vexilla-design.md](../../intro-and-heraldry/vexilla-by-vexilla-design.md). **Seat chronicle (not unique banner art):** **Witness Ford intercept** (096.M42) — joint void containment with Black Templars.  
...
* **Armor — *Typus Octavus — Malevent* (Legatus configuration):** Noviomagus **artificer Mark X Tacticus** — co-designed with **Kadmos** (*rite of the block*); seat reads **void boarding**, **Maleventum EM watch**, and **left-shield interlock** — not grav-lock trench, jump assault, or TDA siege. ~**90% industrial grey** chassis. **Chest aquila** (Legatus law).  
  ...
  * **Explicit negatives:** No Crux · no PRIMA chains · no integral jump pack · no storm-shield integral mount (QVARTA pattern) · no TDA daily plate · no Quintus / Sextus crest exceptions.  
...
* **Temperament:** Cold amusement at **reef pirates** who think jamming equals invisibility; respects **Drukhari** cunning without admiration.  
* **Voice:** Soft on open vox — **Maleventum** habit; spikes volume only on **hardline** ship channels.  
* **Flaw:** **Insomnia** masked by duty — *Medicinae* monitors; he accepts sedatives only when **Drusus**-signed.  
* **Field quote (attributed):** *“Your auspex lies. The hull doesn’t.”*
...
* **Cassian Vetra:** **Threshold partners** — friction over **who dies louder** for signal time; mutual battlefield trust.  
* **Elara Solis (fleet):** Rare **Navy–Astartes** planning windows; Malevent speaks **geometry**, Solis speaks **burn budget** — meetings are short.  
* **Peer Legati:** **Void** fire brigade; sometimes resents being treated as “boarding specialists” when his Vexilla **owns** half the outer reef.
