# \[WIKI\] CHARACTER DOSSIER: EINAR DREADWOLF
...
| **Hands** | **Wolf Talons** — Space Wolves–adjacent lightning claws (Wolverine geometry: blades mounted **over** the hand / knuckle line, fingers free beneath); **red** energy-field glow (not blue). Origin: ship-pattern claws taken aboard **Kzorn’s Maw** during capture; later **purified and remade** into Castra Vetera interface standards under **Kadmos** with *Reclusiam* oversight (**Varro** / clergy) |
...
* **Armin Sturmwahl:** Beloved brother; not his chain-of-command after **Amissi** induction.  
* **Varro:** **Direct responsible officer** — loyalty and orders flow through Judex, not affection.  
* **Drusus:** Clinical owner of Nails logs; sheath clearance; terminis hardware. Among Batavi, the **deepest operational parallel** to Einar’s struggle — Drusus will not call it empathy; *Apothecarion* files **primary-sample continuity** and **watch excess** on telemetry. Varro’s soul-read: Einar = tripartite bind (**hold slipping**); Drusus = **wolf by the throat** at the bars ([`dossier-drusus.md`](../triumvirate/dossier-drusus.md) §4.1 · [`projection-aurea-wolfs-curse.md`](../../../biological-encyclopedia-bestiary/projection-aurea-wolfs-curse.md) §C).  
* **Tyvar:** Custodes flags **containment-adjacent** watch.  
* **Chapter ranks:** Honored at distance; **no cult**.

---

## 6\. Soul geometry (Judex / *Vermilion* — not open Administratum)

| Element | Einar |
|---------|--------|
| **Cage** | Almost **broken** |
| **Wolf** | Fights **Red Demon** — not **child-soul** |
...
**Cross-reference:** [amissi-the-lost.md](../../doctrine-and-organs/amissi-the-lost.md) · [steppenwolf-doctrine.md](../../doctrine-and-organs/steppenwolf-doctrine.md) §5.1 · [dossier-armin-sturmwahl.md](../legati/dossier-armin-sturmwahl.md) · [dossier-varro.md](../triumvirate/dossier-varro.md) · [master-chronology.md](../../events-and-chronologies/master-chronology.md) §IV · §VI · [dreadwolf/INDEX.md](../../../chronicles/dreadwolf/INDEX.md).
