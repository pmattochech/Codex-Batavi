...
*Naming note (OOC):* **Radulf** = Germanic *rad* (counsel, the advisor’s office) + *wulf* — a **mentor** without borrowing **father**-shaped Imperial grammar. **Castrin** nods to *castra* (the camp, the line you **hold**).

---

## 1. Identity (what the Chapter projects)
...
*Revision rule:* When entombment is tied to a chronicle, add one dated line and re-check Triumvirate and Wolf’s Curse continuity.
