# \[WIKI\] CHARACTER DOSSIER: MARKUS GRAILE

*(Emperor’s Wolf / LVPVS IMPERATORIS — DECIMA battle sovereign under the Castellan)*

**Full name:** Markus Graile.  
**Rank / office:** **LVPVS IMPERATORIS** (heraldic stamp) — **Emperor’s Wolf** (English scrolls); **Lord Executioner** (classic VIII); Imperial gloss **Emperor’s Champion** / **Chapter Champion**.  
...
*He is the **lunge**. Alaric is the **hold**. Graile filed that as identity, not complaint.*

* **Temperament:** Controlled. **Pedagogical** when instructing — corrects errors with **one** demonstration cut, not speeches. In champion summons: **absolute** compliance geometry. Interior affect is **full**; Human-typical proof (smile, laugh-as-reassurance, tears as signal) is **clamped** — same Chapter law as the line ([batavi-affect-kinesics-and-mortal-literacy.md](../../doctrine-and-organs/batavi-affect-kinesics-and-mortal-literacy.md)). Emotion transmits as **stillness gradient**, **where he puts mass**, **when the Pair comes out**, **who he will not leave**.  
* **Voice:** Even, unremarkable on instruction nets — useful when DECIMA must **not** overshadow a host Legatus’s vox. When the Pair is live: **silence** carries the threat. He does not orate the Iron Protocol; he **terminates** after the wall has already been named.  
* **Behaviour:** Appears when something is **already decided**. Does not linger in mortal rooms to be liked. Instructor-out: corrects the angle, leaves the seat’s world to its Legatus. Will die **without** a receipt. The Pair is moral order as well as fencing: he will **not** Bite without Decreto — no nameless kill, even when Furor wants the run.  
* **Flaw:** **Imposter whisper** — knows he will never be Triumvirate, never a Legatus Ring vote. The ache goes into **harsher** self-audits and **cleaner** kill files, not into grabbing a seat. Valerian taught him loyalty as a **choice**; the office is what that choice **costs**, not a crown.  
* **Field quote (attributed):** *“The Emperor dictates. The wall holds. I terminate.”*

### 2.1 How DECIMA reads him

DECIMA is native to Batavi kinesics. They do not need a speech to know the weather.

* He is **theirs** in the grid and **never fully theirs** — Castellan’s knife first. Pride and distance in the same file.  
* Median plate reads as **permission**: a brother can become this; he cannot become Alaric. That is why they accept his corrections without theater. Shame under Graile is a **wrong angle**, not a sermon.  
* They watch his curse the way a pack watches the lead hunter’s heat. If he runs **hot** in a champion window, they match the spend. If he goes **cold** after the Bite, they **hold**. A Graile who **does not come home** from the lunge would be a Chapter problem — they would feel it before *Medicinae* stamped it.  
* Instructor-out on foreign Vexilla soil: they loan him as **standard**, not as a second governor. He is careful not to collect their loyalty.

### 2.2 How Noviomagus people read him

Mortals are **not** owed his tells. Martha learns **Alaric**. Serfs and hive cadres do not get a kitchen Graile.

* Coarse read: the Castellan’s **ending** — median grey, two blades, the **justice** cloth (wolf slain by sword). Not the Father. Not the wall. The thing that **arrives when the decision is already made**.  
* Forge and hive who load **tithe hulls** may see him on a window: DECIMA riding twenty years of spoil. They file him as **escort death**, not as a man who shares sweat in the trench. Brief, sealed, gone.  
* Long-service DECIMA serfs can earn **this** brother after years beside the cages — not “Batavi generally,” not a cheat sheet for the next helm. Most of Noviomagus never will.  
* He does not perform Shared Sweat as a public warmth. The debt is real; his channel for it is **the convoy leaving on time** and **the named kill**, not lingering in the hab.
...
Not Alaric’s Type III **hold**. Graile’s curse wants the **lunge** — Furor as acceleration toward a **named** kill.

* **Leash:** ***Modus Binorum Ferrum***. **Decreto** is the man: the kill is issued, witnessed, bounded. **Termini** is the wolf: termination delivered. No Bite without decree. That is *Axiom* as two strokes, not a speech.  
* **Spend and return:** Champion window — he **spends** Furor (and, if the geometry demands, deeper harness) to enter enemy command and come back. After the Bite he **returns to median**. Failure mode is **staying in the lunge** — not coming home to the wall. That is **not** the Red Wolf (Castellan exception; upright savage breach, friend–foe fail). Do not file Graile as a second Red Wolf.  
* **March / Wild Hunt:** Tactical variables, not identity. Zero logged *Axiom* discipline failures in the packets *Strategium* will show. Drusus reads him as the Chapter’s **spending-blade** — different telemetry from the Anchor.  
* **Body as fence:** Median morphology is also curse hygiene. He will not grow a monument the line cannot copy; Execratio vanity is a different man’s damnation.  
* **Interior rhyme:** Imposter whisper and the wolf agree that he is **only the Bite**. Axiom answers: the **man** issues Decreto first. Valerian is the scar under that argument — brother-war heat, curse running in the Chapter, and he stayed **useful**.
...
* **Noviomagus mortals:** §2.2. No kitchen bond.
