...
**Related:** [infantry-visual-identity.md](arsenal-and-logistics/infantry-visual-identity.md) — infantry breakdown; [dossier-alaric.md](personae-command-index/character-dossiers/triumvirate/dossier-alaric.md) — Castellan chassis; [dossier-markus-graile.md](personae-command-index/character-dossiers/cohorts-and-detachments/dossier-markus-graile.md) — Emperor’s Wolf helm / kit; [dossier-drusus.md](personae-command-index/character-dossiers/triumvirate/dossier-drusus.md) · [dossier-varro.md](personae-command-index/character-dossiers/triumvirate/dossier-varro.md) — Triumvirate *Medicinae* / *Reclusiam*; [dossier-otho.md](personae-command-index/character-dossiers/council-orders/dossier-otho.md) · [dossier-kadmos.md](personae-command-index/character-dossiers/council-orders/dossier-kadmos.md) — Extended Council (*Librarium* / *Armourium*); § **Reference art** below for working PNGs; [intro-and-heraldry.md](personae-command-index/intro-and-heraldry/chapter-identity.md) — frontal wolf charge (**no lunar field**); [vexilla-by-vexilla-design.md](personae-command-index/intro-and-heraldry/vexilla-by-vexilla-design.md) — Vexilla banner / *justice* vexillum layout; GW silhouette refs in [`lore-images/reference-gw-luna-wolves-source/`](lore-images/reference-gw-luna-wolves-source/README.md).
...
**Approved rasters:** [`lore-images/chapter-seal-official.png`](lore-images/chapter-seal-official.png) — **primary chapter roundel** (author-approved framing from the QVARTA vexillum art; **349×349** RGBA, **transparent outside the outer black ring** — tight square bound to the detected circle; re-run circle detect if you replace the source art). **Frame on this file:** **black** ring at the outer edge of the roundel (no separate outer crimson hairline — removed from source **2026-05-25**). **Do not** replace with an automated re-crop from [`vexillum-Vexilla-iv-QVARTA.png`](lore-images/vexillum-Vexilla-iv-quarta.png) unless you re-match this framing. Legacy / flat trace target (if present in your tree): [`lore-images/chapter-seal-canonical.png`](lore-images/chapter-seal-canonical.png). **Colour law** remains the table below — do not drift palette from this raster alone.
...
**Vexilla banner (Ancient):** Use **this seal palette** on the **vertical / pennant** banner. **Not** mounted on the Legatus ***Alabarda***. **Layout:** default **Chapter** face + **LATIN-CAPS** ordinal per [vexilla-by-vexilla-design.md](personae-command-index/intro-and-heraldry/vexilla-by-vexilla-design.md) (PRIMA: **obligation** — symbolic geometry, **no** traitor slogans; **§2.2**). Unique per-seat victory art is **dropped**. DECIMA **justice** panel (wolf slain by sword) is a **different** brief — same file §4. Abbreviated wolf composition allowed where scale demands; **no** alternate chapter colours or charges. Mount and furl: *Armourium* field spec (**Ancient’s** staff); base law [`intro-and-heraldry.md`](personae-command-index/intro-and-heraldry/chapter-identity.md).
...
| Subject | File | Notes |
|---------|------|--------|
| **Alaric** — ***Castra-Lupus — Helis*** (full figure) | [`lore-images/alaric-castra-lupus-helis.png`](lore-images/alaric-castra-lupus-helis.png) | **Official full-figure lock.** Standing Castellan: *Caput Ferreum* in the cowl, Cataphractii slab, **Batav** black wolf **left** / **Viggo** white **right** (flank profile), *Breakwater* planted, *The Sentence* at the hip. [`dossier-alaric.md`](personae-command-index/character-dossiers/triumvirate/dossier-alaric.md) §1.2 · [`castra-lupus-doctrine.md`](arsenal-and-logistics/castra-lupus-doctrine.md) §5. |
| **Alaric** — ***Caput Ferreum Castellani*** (*Iron Head*) | [`lore-images/alaric-caput-ferreum-castellani.png`](lore-images/alaric-caput-ferreum-castellani.png) | **Official helm lock** (close-up). Grey industrial wolf (muzzle, inner ears, jaw, teeth, cylinders) wearing a **red galea** (crown, crest, brow, cheeks, outer ear shells). Bright amber-orange lenses. **Not** a visor stripe; **Versibar** who remained a soldier. [`dossier-alaric.md`](personae-command-index/character-dossiers/triumvirate/dossier-alaric.md) §1.2 · [`castra-lupus-doctrine.md`](arsenal-and-logistics/castra-lupus-doctrine.md) §2. |
| **Graile** — **LVPVS IMPERATORIS** (Emperor’s Wolf) | [`lore-images/graile-helm-lvpvs-imperatoris.png`](lore-images/graile-helm-lvpvs-imperatoris.png) | **Official helm lock** (close-up). Relic Mk X: **crimson** bowl, **white** mouthplate, **orange** lenses, **iron** laurels + brow skull. **No** Furor visor bar (office exception — red lives in the bowl). Kit law (cape, partial Batav **game**, sleeping head **left**): [`dossier-markus-graile.md`](personae-command-index/character-dossiers/cohorts-and-detachments/dossier-markus-graile.md) §1. **Full-figure PNG not locked.** |
