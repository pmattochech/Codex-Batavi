...
| Subject | File | Notes |
|---------|------|--------|
| **Alaric** — ***Caput Ferreum Castellani*** (*Iron Head*) | [`lore-images/alaric-caput-ferreum-castellani.png`](lore-images/alaric-caput-ferreum-castellani.png) | **Official helm lock.** Grey industrial wolf (muzzle, inner ears, jaw, teeth, cylinders) wearing a **red galea** (crown, crest, brow, cheeks, outer ear shells). Bright amber-orange lenses. **Not** a visor stripe; **Versibar** who remained a soldier. [`dossier-alaric.md`](personae-command-index/character-dossiers/triumvirate/dossier-alaric.md) §1.2 · [`castra-lupus-doctrine.md`](arsenal-and-logistics/castra-lupus-doctrine.md) §2. |
