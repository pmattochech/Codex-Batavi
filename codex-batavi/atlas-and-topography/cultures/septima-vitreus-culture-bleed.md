...
| **Anti-scatter / anti-glare ethics** | No tracer vanity; matte anti-glare plate panels; cloth may stay furled under photonic hash | Stray scatter as prosecutable sin; smoked kit grade as class police; vanity polish as soft heresy |
| **Dual seal culture** | Legatus tick + Techmarine / machine auspex tick per manifold node (Kadmos rite in chain) | Dual human/machine stamp on yield audits; civilians learn “two ticks or it didn’t happen” without knowing vent doctrine |
| **Shared Sweat** | Auxilia / PDF hold docks beside melt hands; hierarchy returns after bloom | Civic pride without kinship claim; veil-minute swaps; iodine tabs |
| **Facet taps / gear-prayer cousin** | Friction habit into duty-belt — knuckle on plate before vent | Three knuckles on smoked glass — local rite; not Chapter endorsement |
| **Glass-diver route literacy** | Blind / honest-impairment guides sell trenches to auxilia (“left is cheaper”) | Highest practical status ladder; hazard stamps as currency; Astartes as dangerous customers, not saints |
...
**Short:** Glass Burn nickname; dock-shadow route changes; Shared Sweat pride; cold Mechanicus–Chapter courtesy as district weather; folk Null-Vent plate story; quiet priests rising where dazzle fails.
...
Institutions drawn from Phase A §7A that **actually touch** Chapter shadow. Depth mandate: Mechanicus is **Core** — handshake gets maximum pages.

### Adeptus Mechanicus (Core) — lens sovereignty handshake
...
**Friction flavors allowed in fiction:**

- Cold courtesy in one corridor: plate and grey plate side by side; palms scrubbed bloodless; orange lenses vs too-bright Magos eyes or honest veils.
- Calibration argument over underburn sequence vs forge “compliance maximizes yield” sermon-threat — both want the cascade not to happen; neither yields creed.
- After **112.M42**: folk pride in the Burn; Magos silence on skitarii names; Chapter field 4 quiet on the *Alabarda*; mortals smell the gap and invent softer stories.

**Sin at the Mechanicus seam:** Stray scatter as yield heresy (populi / forge); unlogged lens diversion; off-books mirror gifts; treating instrument lies as miracles; Chapter-side careless plasma that voids a plate’s hash. **Do not** let forge-priests preach Founding genealogy; **do not** let Chapter mouths grant Mechanicus ownership of Ancestor-Sovereign.
...
Optic registries, shade windows, tithe seals. Parallel facet keys vs Chapter guest ink = two verticals on one porch. Sin: misfile that creates scatter liability. Bleed: clerks learn not to argue a sealed vent corridor with a plaque alone.
...
Route sellers to auxilia and occasional Astartes customers. Highest honest-impairment status. Bleed: trench literacy; hazard stamps. Hard edge: empty-socket theology ≠ Chapter Visage / helm law (do not invent helm permission from diver fashion).

### Refraction courts / lens notaries (Core, seat-specific)

Law as optics; shard confession. Bleed: Facet Houses broker civil angles near Chapter-civil rooms. Hard edge: court cannot adjudicate vent dual seal; Chapter does not sit as refraction judge.
...
| Org | Seam note |
|-----|-----------|
| **Navis Nobilite** | Thin route fees; “left is cheaper” quoted at arrogance — not Chapter doctrine |
| **Astra Telepathica** | Thin; mute rhyme with vent windows; Librarium folk-echo as “noise budget” near forges — rumor only |
| **Inquisition** | Sealed/rumor — lab quarantines as weather; no open Ordo street cult in bleed scenes unless ordered |
| **Other Astartes** | Sealed/rumor — Batavi seat shadow dominates; no rival Chapter culture dump |
| **Sororitas / Custodes / Assassinorum** | Absent as civic institutions — do not invent convent or golden vigil on Vitreus for flavor |

### Mechanicus Core handshake — worked incident type (fiction lock)

**Name (working):** *Plate Seven Mute Concord* (folk) / dual-seal containment drill (Chapter–Mechanicus).

**Populi see:** Vent bells; skitarii freeze; melt psalm dies; stalls move; Glass Burn rumor if Legatus is on the plate; later ash in throat or clean hash depending on outcome.

**Chapter does:** Vent-window sign-off; sequential underburn; friend–foe discrimination held while material failure screams for attention — failure-risk named in Legatus Ring notes, **not** in booth primers.

**Mechanicus does:** Machine tick; feedstock and mirror-row lockdown; treaty redaction if allied machine-dead must vanish from public slate.

**Wrong write:** Merge into one “clarity Mass.” **Right write:** Three clocks, one silence, three ownerships.

---

## B7. Fiction tells

- **Mortal → Vexilla signal:** Who shares **veil-minutes / iodine / mute** under bloom without a sermon; whether stalls move for grey plate; whether a knuckle-click is copied as luck or ignored as protocol weather.
- **Brother → populi signal:** Smoked kit grade → plaque / angle stamp → who looks *past* glass → dark veil as status vs rag film as poverty → Facet porch guest ink **stops** at Chapter-civil paint line.
- **Mechanicus → both signal:** Second tick required; cold courtesy denser than chapel heat; red-tag that does not care about Melts piety.

**Wrong:**

- Collapsing Batavi into God-Emperor / clarity-saint worship  
- Equating **stray scatter** with careless plasma / vent shame  
- Facet House or diver covenant as Chapter billet / helm law  
- Full **Silica Field** culture or Phase C ethnography dumped into Vitreus streets  
- Founding / progenitor gossip in populi or casual brother mouths  
- Opaque friend–foe abbreviations; clinical curse taxonomy as street catechism  
- Null-Vent sealed AAR (casualty math, skitarii names, field-4 theology) as booth sermon  
- Magos and Legatus as one forge mind  

**Right:**

- Instrument before eyes; stray scatter as **civic** sin word  
- Glass Burn as **surface** Legatus nickname; knuckle-click as protocol tell  
- Shared Sweat without kinship claim  
- Dual seal / dual stamp as **rhyme**, not identity  
...
Matte anti-glare panels; orange lenses; knuckle before window; Legatus pole planted at manifold / lens-array choke; **Ancient** cloth furled under hash; cold nod to Magos; no feast brightness.
...
*Revision discipline:* dates and battle outcomes in chronicle / AAR supersede ethnographic generalizations if they conflict. Chronological blindness: mortals know glare weather, treaty coldness, Glass Burn rumor, and dual-stamp habit — not sealed gene-architecture, clinical curse taxonomy, or friend–foe discrimination doctrine as catechism.
