...
## Noviomagus Prime (Capital of the Geartrain)

**Scale & role:** ~**120 billion** in stacked hives; **civilized forge world** — arms, armor, and shameless throughput. Direct Chapter administrative shadow.
...
**Social structure:** **Scribe bloodlines**, **noble tithe houses**, **advocates** (semi-licensed duelists of paperwork). Marriage is **contract-first**; love is **not illegal**, merely **badly documented**.

**Fork:** Late-imperial **consistory** — faith looks like **procedure**. Outsiders call it cold; locals call it **honest**.
...
**Porta Nihili flavor:** Public devotion is **rest virtue** — *“the Throne grants sleep to the useful.”* Private chapels quietly record **conception offerings**. Guilt and glory share a bed; **sin** is **wasting seed** outside quota.

**Social structure:** **Hosts** (hospitality caste), **midwives** with Administratum ranks, **audit confessors** who speak softly and take blood samples.
