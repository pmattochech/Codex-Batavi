# The Crucible — per-world human culture

**System atlas:** [system-ii-crucible.md](../systems/system-ii-crucible.md)  
**Basal stratum:** [porta-nihili-and-basal-stratum.md](porta-nihili-and-basal-stratum.md)

---

## Incus-Gravis Tertius (The Super-Earth — shingle seas)

**Scale & role:** **~2.8G** flats; **inverted hive** urbanism carved into **adamantium crust** — **Auxilia** labor and **neophyte conditioning** backbone.

**Economy-ecology:** Weight is **truth**. Bone microfracture is **liturgy**. Rain is **shingle slide** — sound defines districts.

**Porta Nihili flavor:** God loves **what does not buckle**. Holidays are **load festivals** — carry, don’t sing. Confession is **bone scan**.

**Social structure:** **Weight guilds**, **compression marriages** (pair for load-share), **orthotic clergy** who bless **straps** not souls first.

**Fork:** **Highland-anvil barbaricum** — honor is **posture under crush**. Not height; **yield point**.
