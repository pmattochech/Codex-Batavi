...
| ***Rubor thermicus*** (RTC) | *Apothecarion* clinical name for the same event; **≤1** per engagement when failure occurs. **I:** Malakor V (**050.M42**, full). **II:** Garmr’s Shelf (**~545.M42**, **Type B** abbreviated — Viggo pup). Third **full** window disputed. [`crimson-wolf-rubor-thermicus.md`](personae-command-index/doctrine-and-organs/crimson-wolf-rubor-thermicus.md) |
