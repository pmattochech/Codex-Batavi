...
| **the Reclamation** (*Recuperatio Vetera*) | Birth-war: they become Batavi by taking Castra. **Pre-Cadia.** Scaffolds: [`chronicles/reclamation/INDEX.md`](chronicles/reclamation/INDEX.md). Staff: [`the-reclamation.md`](personae-command-index/events-and-chronologies/the-reclamation.md). **Forbidden name:** Foundation War. |
...
| **Shared Sweat** | Moral debt to mortals who labored beside the wall. [`master-chronology.md`](personae-command-index/events-and-chronologies/master-chronology.md) §II. |
| **Der Batav** | Native civic **myth** and Chapter name (*the iron that stayed*). **Aethelgard people** name what they **see** on the shingle; **Cohors Batavorum** follows from lungs. Not a Campaign III chronicle. [`der-batav-myth.md`](lexicon-and-litanies/der-batav-myth.md). |
