...
| **LVPVS IMPERATORIS** | **Emperor’s Wolf** — Chapter Champion office (heraldic inscription Latin); **Lord Executioner** (classic VIII); Imperial gloss **Emperor’s Champion**; one incumbent; commands **DECIMA** battle grid on Castellan orders; **not** a Legatus. Incumbent: **Markus Graile**. [`legatus-chapter-mastery.md`](personae-command-index/doctrine-and-organs/legatus-chapter-mastery.md) · [`military-hierarchy.md`](personae-command-index/doctrine-and-organs/military-hierarchy.md) §3 · [`dossier-markus-graile.md`](personae-command-index/character-dossiers/cohorts-and-detachments/dossier-markus-graile.md) |
...
| **Isolation fence** | MoI realspace+Warp **reflector**; Cicatrix splits into a **V**. Anomaly **~once per 20 years**. [`insula-tenebrarum-isolation-fence.md`](atlas-and-topography/insula-tenebrarum-isolation-fence.md) |
