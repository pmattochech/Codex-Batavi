...
| **Vexilla** | Tactical unit **and** its battle cloth — **same word**. Spoken seat names always LATIN-CAPS: **PRIMA**, **SECVNDA**, **TERTIA**, **QVARTA**, **QVINTA**, **SEXTA**, **SEPTIMA**, **OCTAVA**, **NONA**, **DECIMA**. Do **not** say “Vexillatio(nes)” or “from the V QVINTA Vexilla”; say **from QVINTA**. Not the geographic Nine Phalanx. |
...
| ***Alabarda*** + **Vexilla** | **Legatus** halberd (**Alabarda**) and unit battle cloth (**Vexilla**) — **carried together**, **not permanently fixed**. Cloth may **detach** and be **ground-pinned** separately. Four panel fields: chapter achievement, **LATIN-CAPS** ordinal (**PRIMA**–**NONA**), anchor/specialty, **greatest success**; **PRIMA**: fourth = **obligation / remembrance** (symbolic only), **broken-cog** border ([`vexilla-by-vexillatio-design.md`](personae-command-index/intro-and-heraldry/vexilla-by-vexillatio-design.md) §2.2). Haft **relay**. **Head groups** (*Types* **Primus**–**Fulmen**) + detach/plant law: [`alabarda-head-groups.md`](arsenal-and-logistics/alabarda-head-groups.md). |
| ***justice vexillum*** (DECIMA) | **Anchor-guard** standard — **feral wolf killed by sword** (Malakor / First Legatus treason ended); not a tenth *Alabarda* duplicate. [`vexilla-by-vexillatio-design.md`](personae-command-index/intro-and-heraldry/vexilla-by-vexillatio-design.md) §4; [`military-hierarchy.md`](personae-command-index/doctrine-and-organs/military-hierarchy.md) §3. |
