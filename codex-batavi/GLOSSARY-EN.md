...
| ***Adversarii at Portas*** | **Black Cell** terminal protocol: **Versibars** as area denial when defeat is certain. **Battlefield** first documented at **Malakor V** — **Blutrecht** + **Alpha**-vectored **loyal Versibars** vs traitors; not indiscriminate **Portas** — encyclopedia **Exanimus Testament** block. |
