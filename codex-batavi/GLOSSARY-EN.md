...
| **Valerian Heresy** | Formal name for **Valerius** treason and **I** *Prima* rot (**Malakor V**, 050.M42); ~**300** Chapter losses (**KIA** / **Versibar**); leaves **~200** **Firstboot** core — see [`master-chronology.md`](personae-command-index/events-and-chronologies/master-chronology.md), [`projection-aurea-wolfs-curse.md`](biological-encyclopedia-bestiary/projection-aurea-wolfs-curse.md). |
