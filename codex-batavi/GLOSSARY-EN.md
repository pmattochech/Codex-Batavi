...
| **Vexilla banner** | Four-field battle cloth (**PRIMA**–**NONA**). **Bearer:** **1st company captain**. Panel: chapter achievement, **LATIN-CAPS** ordinal, anchor/specialty, **greatest success**; **PRIMA**: fourth = **obligation / remembrance**, **broken-cog** border ([`vexilla-by-vexilla-design.md`](personae-command-index/intro-and-heraldry/vexilla-by-vexilla-design.md) §2.2). Unit and cloth still share the word **Vexilla**. |
