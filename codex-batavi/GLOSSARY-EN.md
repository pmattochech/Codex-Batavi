...
| **LVPVS IMPERATORIS** | **Emperor’s Wolf** — Chapter Champion office (heraldic inscription Latin); **Lord Executioner** (classic VIII); Imperial gloss **Emperor’s Champion**; one incumbent; commands **DECIMA** battle grid on Castellan orders; **not** a Legatus. On a **tithe-window**, DECIMA is **core escort** of the super-tithe while the Castellan **holds** the mesh. Incumbent: **Markus Graile**. [`legatus-chapter-mastery.md`](personae-command-index/doctrine-and-organs/legatus-chapter-mastery.md) · [`military-hierarchy.md`](personae-command-index/doctrine-and-organs/military-hierarchy.md) §3 · [`dossier-markus-graile.md`](personae-command-index/character-dossiers/cohorts-and-detachments/dossier-markus-graile.md) · [`insula-tenebrarum-isolation-fence.md`](atlas-and-topography/insula-tenebrarum-isolation-fence.md) §IV |
...
| ***Alabarda*** + **Vexilla** | **Legatus** halberd (**Alabarda**) and unit battle cloth (**Vexilla**) — **carried together**, **not permanently fixed**. Cloth may **detach** and be **ground-pinned** separately. Four panel fields: chapter achievement, **LATIN-CAPS** ordinal (**PRIMA**–**NONA**), anchor/specialty, **greatest success**; **PRIMA**: fourth = **obligation / remembrance** (symbolic only), **broken-cog** border ([`vexilla-by-vexilla-design.md`](personae-command-index/intro-and-heraldry/vexilla-by-vexilla-design.md) §2.2). Haft **relay**. **Head groups** (*Types* **Primus**–**Fulmen**) + detach/plant law: [`alabarda-head-groups.md`](arsenal-and-logistics/alabarda-head-groups.md). |
