...
The **grey + crimson pauldrons** scheme applies to **284** pure-line Batavi (PRIMA–NONA) or **279** (DECIMA), **and** the **16** organic-support Marines per Vexilla (Apothecary, Techmarine, adjutant Chaplain, **Batavian Haruspex** — each order with its own function markers). The **four cohorts** (50 each, **200** total) keep the same grey-red base, but the **right pauldron** follows cohort code. (*Frozen table:* [vexillationes-and-visual-summary.md](vexillationes-and-visual-summary.md) §1.1.)
...
- **Legatus *Alabarda* + Vexilla (off-plate):** Halberd-mounted **four-field** banner — same Chapter palette as seal; per-Vexilla register, PRIMA obligation §2.2, DECIMA **justice** vexillum separate — [vexilla-by-vexillatio-design.md](../personae-command-index/intro-and-heraldry/vexilla-by-vexillatio-design.md).
