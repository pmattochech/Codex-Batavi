# VEXILLA AND VISUAL HIERARCHY

*Cross-reference document for [military-hierarchy.md](../personae-command-index/doctrine-and-organs/military-hierarchy.md) (§3 — macro-command, Legatus and DECIMA; §4 — frozen table).*

---

## 1 THE TEN VEXILLA (CHAPTER ORGANIC STRUCTURE)

The *Cohors Batavorum* fields **5,000** battle-brothers in **ten Vexilla** of **500** warriors each — a deliberate structure to cancel *Codex* bottlenecks on the *Loken Passage* frontier.


| #                | Designation                                         | Anchor / employment                                                                                                                     | Command                                                                                  |
| ---------------- | --------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- |
| **PRIMA–NONA** | **PRIMA** … **NONA** (*Strategium* LATIN-CAPS seats) | Each of the **nine super-systems** of the **Nine Phalanx** (3×3 mesh; see [general-atlas.md](../atlas-and-topography/general-atlas.md)) | **Legatus** (*Elder-Master*) bears the *Alabarda*; **Ancient** bears the **Vexilla banner** |
...
***Alabarda* / Vexilla banner (quick ref):** two objects. **Alabarda** = Legatus **weapon** (haft **relay** + merged tactical ***auspex***; **no cloth on the pole**). **Vexilla banner** = default Chapter face + **LATIN-CAPS** ordinal, borne by the **Ancient** (one per Vexilla, Legatus retinue). **PRIMA**: **obligation/remembrance**, **broken-cog** border — [vexilla-by-vexilla-design.md](../personae-command-index/intro-and-heraldry/vexilla-by-vexilla-design.md) §§1–2. **DECIMA**: separate **justice vexillum** (feral wolf **slain by sword**) on the **Emperor’s Wolf** — same file §4. **No** company banners. Also: [intro-and-heraldry.md](../personae-command-index/intro-and-heraldry/chapter-identity.md); [military-hierarchy.md](../personae-command-index/doctrine-and-organs/military-hierarchy.md) §3.
...
## 2 SPECIALTY COHORTS (DISTRIBUTED ORGANIC STRUCTURE)

The four cohorts are **doctrinal and heraldic identities** present in **all** PRIMA–DECIMA as **four cells of 50**. There are no “floating cohorts” separate from the 500 map: the Chapter is a **10 × (4×50)** grid of specialists, plus pure line, support, and (in the Tenth) supreme command.

*Colors and iconography:* [specialty-cohorts.md](specialty-cohorts.md).

*Cohort weapon table (same in every Vexilla):* [cohort-standard-kit.md](cohort-standard-kit.md).
...
- **Siege Division (veterans):** rim **gold**. (*Storm* shields; heavy *testudo*.)
