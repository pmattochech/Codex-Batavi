# Deathwatch and the *Cohors Batavorum*

*Ordo Xenos kill-teams sit inside the same Imperial machine as the Holy Ordos; the Wall treats them as a **specialized creditor** — useful, dangerous, and owed a measured blood-price.*

---

## 1. Where this sits in Chapter diplomacy

Deathwatch operations are **not** a separate peace. They fold into [inquisition-geometry.md](inquisition-geometry.md): the **super-tithe**, ***Limes Lupus*** **Treaty**, **hierarchical transparency**, and **witness clause** still apply. The difference is practical: Watch commanders want **bodies and results** against xenos more than they want theological trials — as long as those bodies do not arrive **contaminated**, **unstable**, or **politically radioactive**.

The Triumvirate’s answer is the same core equation as everywhere else: **indispensability is immunity**, but **utility buys corridor space**. Loaned Batavi make the Watch **win**; wins are logged; logged wins become **tolerance** for the Chapter’s non-*Codex* strength and sealed biology.
...
## 4. *Strategium* policy (operational rules)
...
### 4.1 Certified *Watch cycle* (definition)

A **certified *Watch cycle*** satisfies **all** of:

* authorized **embarkation** under *Strategium* orders and **Liaison-Praefect** (*Pactum Clavis Sanguinis*) seals;  
* **completion** of the assigned Deathwatch operation or **honorable** early extraction logged by Watch command (abandonment or desertion **voids** certification);  
* **return** to a Chapter debrief anchor;  
* **clinical** clearance (*Medicinae*) and **Reclusiam** post-audit (Varro’s office) **without** pending discipline for Watch-period conduct.
...
Watch medicine and *Medicinae* do not merge; they **handshake** under a written protocol the Triumvirate calls ***Pactum Clavis Sanguinis*** (informal *Strategium* name: **the blood-key compact**). Its purpose is to keep loaned Batavi **alive** and **compliant** without giving Watch genetors enough rope to hang the Chapter.
...
Each major request or rotation is paired with a **Watch Apothecary designate** (name and face **variable** by theater — the Chapter does not canonize them). That designate signs the same **compact appendix** for the mission: joint accountability if a loaned Marine **dies wrong** (gene-theft, unauthorized sampling, delayed *Furor* intervention). If the Watch refuses a designate, Drusus’s office **withholds** the rotation.

### 5.3 Tiered disclosure (operative summary)
...
### 5.4 Practical workflow

1. **Pre-embarkation:** Riis’s seal on the brother’s **auspex-clavis** — a time-boxed cryptographic tag Watch medicae readers honor as “cleared this window.”  
2. **In theater:** Watch treats the Batavi as **their** casualty until **evac to Chapter node**; Riis or a **pre-briefed** deputy must be on **vox** for Tier Black events.  
3. **Return:** Riis or *Medicinae* deputy runs **first blood draw** before Watch archives copy; samples **split** under witness where treaty demands.

---

## 6. Lore fit (themes)

* **Machine, not family:** Deathwatch is another **gear mesh** — the Wall does not sentimentalize “all Astartes brotherhood”; it **prices** each rotation.  
* **Transparency as currency:** A Batavi who excels under Watch eyes becomes **evidence** that the Chapter’s monsters are **deployable**, not **feral**.  
* **Risk to secrecy:** Every deployment is a **leak surface** for phenotype and doctrine. That is why rotations are **sparse**, **vetted**, and **witnessed** on Chapter terms.

---

## 7. What the Watch is to a Batavi (phenomenology)
